...
plots = [
	...
	(False, 'Msg density', 'msgden', 'messages per edge', False, 0, 100, 5, -30, '%.0f'),
	(False, 'Throughput per node', 'nodethr', 'messages / node / s', True, 1.0e0, 1.0e4, 10, -60, '%.1e')
]

topologies = [
	# name, style
	('grid2d[8-con]', 'stroke:#009'),
	('grid2d[4-con]', 'stroke:#09d'),
	('grid3d[26-con]', 'stroke:#d70'),
	('grid3d[6-con]', 'stroke:#930')
]
platforms = [
	# label, prefix, style
...
data = Data.read(File('data_grid.csv'))
# add calculated cols
